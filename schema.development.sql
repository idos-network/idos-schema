...
-- CREATE ACTION [IF NOT EXISTS] delete_wallet_as_owner($id UUID) PUBLIC OWNER {
...
CREATE ACTION [IF NOT EXISTS] dwg_message(
    ...
    return idos.dwg_message($owner_wallet_identifier, $grantee_wallet_identifier, $issuer_public_key, $id, $access_grant_timelock, $not_usable_before, $not_usable_after);
}
